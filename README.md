...
- To add a new spending, click on the "add a new expense" button and fill out the form.

- To delete any spending, click on the "delete expense" button to enter delete mode.

- The spending can be sorted into "Newest", "Latest", "Amount: High to Low", or "Amount: Low to High".

- It is possible to filter expenses by year, and there is also a chart showing monthly spending.

## Multiple Versions of Code styling

There are 3 branches that hold 3 versions of the code.
